module WechatVendorPlatformProxy
  class RefundApplyService
    %w[SYSTEMERROR BIZERR_NEED_RETRY TRADE_OVERDUE ERROR USER_ACCOUNT_ABNORMAL INVALID_REQ_TOO_MUCH NOTENOUGH INVALID_TRANSACTIONID
       FREQUENCY_LIMITED].each do |err_code|
