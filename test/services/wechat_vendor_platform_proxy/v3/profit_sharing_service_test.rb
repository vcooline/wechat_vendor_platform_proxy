  ...
  class ProfitSharingServiceTest < ActiveSupport::TestCase
    ...
    test "should add receiver" do
      stub_request(:post, "https://api.mch.weixin.qq.com/v3/profitsharing/receivers/add")
        .to_return(status: 200, body: { account: "TEST_00000000000000000000001", relation_type: "USER",
                                        type: "PERSONAL_OPENID" }.to_json, headers: {})
      ...
      assert_predicate record, :personal_openid?
      assert_predicate record, :user?
    ...
    test "should delete receiver" do
      ...
      assert_predicate record, :destroyed?
    end
    ...
    test "should query transaction remain amount" do
      ...
      assert_predicate resp_info["unsplit_amount"], :present?
    end
    ...
    test "should unfreeze transaction remian amount" do
      ...
      assert_predicate resp_info["out_order_no"], :present?
      assert_predicate resp_info["order_id"], :present?
      assert_predicate resp_info["state"], :present?
    end
